<?php
$input = "cefbd dcg dcfgbae bdeafg gfcaed ecbgd bcag bdacge cg bedag | cebdg egcfda gdacbe badefg
...
for ($i = 0; $i < count($inputArray); $i++) {
    ...
    $inputArray[$i][0] = trim($inputArray[$i][0]);
    $inputArray[$i][1] = trim($inputArray[$i][1]);
    $inputArray[$i][0] = explode(" ", $inputArray[$i][0]);
    $inputArray[$i][1] = explode(" ", $inputArray[$i][1]);
}

$oneCount = $fourCount = $sevenCount = $eightCount = 0;
$result = 0;
...
$result = $oneCount + $fourCount + $sevenCount + $eightCount;
echo "answer: " . $result;
